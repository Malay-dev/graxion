...
const formSchema = z.object({
  ...
  studentsAttempted: z.coerce.number().min(0, { message: "Cannot be negative." }),
...
export function AssessmentDetailsForm({ initialData, onSubmit }: AssessmentDetailsFormProps) {
  ...
  return (
    <Form {...form}>
      <form id="assessment-details-form" onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
