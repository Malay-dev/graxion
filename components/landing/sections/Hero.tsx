      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          ...
          <p className="max-w-screen-sm mx-auto text-xl text-muted-foreground">
            Graxion revolutionizes assessments with AI-powered grading and
            instant video explanations. Say goodbye to manual evaluations and
            enhance learning with step-by-step guidance.
          </p>
        ...
        <div className="relative group mt-14">
          ...
          <Image
            ...
            src={theme === "light" ? "/dashboard.png" : "/dashboard.png"}
            alt="dashboard"
          />
